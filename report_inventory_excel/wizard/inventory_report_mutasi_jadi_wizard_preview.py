...
class InventoryPreviewMutasiJadiReportWizard(models.TransientModel):
    _inherit = 'inventory.export.mutasi.jadi.report.wizard'
    ...
    def print_inventory_preview_report(self):
        return self.env.ref('report_inventory_excel.report_inventory_mutasi_jadi').report_action(self)
