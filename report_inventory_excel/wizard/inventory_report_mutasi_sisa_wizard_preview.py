...
class InventoryPreviewMutasiSisaReportWizard(models.TransientModel):
    _inherit = 'inventory.export.mutasi.sisa.report.wizard'
    ...
    def print_inventory_preview_report(self):
        return self.env.ref('report_inventory_excel.report_inventory_mutasi_sisa').report_action(self)
