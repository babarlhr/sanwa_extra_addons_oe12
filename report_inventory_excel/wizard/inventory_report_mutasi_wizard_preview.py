...
class InventoryPreviewMutasiReportWizard(models.TransientModel):
    _inherit = 'inventory.export.mutasi.report.wizard'
    ...
    def print_inventory_preview_report(self):
        return self.env.ref('report_inventory_excel.report_inventory_mutasi').report_action(self)
