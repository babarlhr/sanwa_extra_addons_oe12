...
class InventoryPreviewPengeluaranReportWizard(models.TransientModel):
    _inherit = 'inventory.export.pengeluaran.report.wizard'
    ...
    def print_inventory_preview_report(self):
        return self.env.ref('report_inventory_excel.report_inventory_pengeluaran').report_action(self)
